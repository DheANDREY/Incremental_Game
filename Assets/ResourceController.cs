...
public class ResourceController : MonoBehaviour
{
    ...
    public void SetConfig(ResourceConfig config)
    {
        ...
        ResourceDescription.text = $"{ _config.Tier } Lv. { _level }\n+{ GetOutput().ToString("0") }";
...

    {
        ...
        AchievementController.Instance.UnlockAchievement(AchievementType.UnlockResource, _config.Tier);
}
